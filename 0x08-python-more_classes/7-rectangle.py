...
class Rectangle:
    ...
    def __str__(self):
        """This function provides the ouput that should Rectangle
        class provide to the end user when it's printed, as well
        as it makes the object readable.
        """
        string = []
        if self.__height == 0 or self.__width == 0:
            return ""
    ...
    def __repr__(self):
        """The repr function is used to provide the internal
        of an object and creates code the reproduces the object.
        """
